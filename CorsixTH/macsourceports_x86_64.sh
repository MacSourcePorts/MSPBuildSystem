...
install_name_tool -change @rpath/libSDL2_mixer-2.0.801.0.0.dylib /Users/tomkidd/Downloads/libs/x86_64/lib/libSDL2_mixer-2.0.801.0.0.dylib "./${EXECUTABLE_FOLDER_PATH}/${EXECUTABLE_NAME}"
