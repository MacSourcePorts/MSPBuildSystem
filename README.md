...
| bstone                      | ☑️                   |                          | Versioned project tags                       |                                                                                 |
...
| OpenJKDF2                   |                     | ☑️                        | Versioned project tags                       | This one needs some attention before I can try and use the project's repo       |
...
| vkQuake                     | ☑️                   |                          | Versioned project tags                       | This one does use release tags but as of this writing the latest tag doesn't run on macOS so we're using the latest code until further notice.  |
