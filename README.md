...
| OpenRCT2                    | ☑️        | ☑️                   |                          | Latest code                                  | This one stays as a fork because of the code we added to look inside the app bundle                                                                                |
...
| shockolate                  | ☑️        |                     | ☑️                        |                                              | Using our own fork for this one, most of the changes since March 2022 or so have been clerical in nature and I had to do a bunch of weird shit to get this one going. Might be worth looking at again later but either way it needs our code to find the files outside of the app bundle.                                                                                  |
| The Ur-Quan Masters         |          |                     |                          |                                              |                                                                                 |
| vkQuake                     |          |                     |                          |                                              |                                                                                 |
