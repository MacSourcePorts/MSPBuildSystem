...
|:---------------------------:|:--------:|:-------------------:|:------------------------:|----------------------------------------------|:-------------------------------------------------------------------------------:|
| Abuse-1996                  | ☑️        |                     | ☑️                        | Versioned project tags                       | Had to modify this one to save outside of the app bundle. Code rarely changes, we can keep this on our own fork.                                                                                |
| ArxLibertatis               | ☑️        | ☑️                   |                          | Versioned project tags                       |                                                                                 |
| augustus                    | ☑️        | ☑️                   |                          | Versioned project tags                       |                                                                                 |
| bstone                      | ☑️        | ☑️                   |                          | Versioned project tags                       |                                                                                 |
| Commander-Genius            | ☑️        | ☑️                   |                          | Versioned project tags                       |                                                                                 |
...
| Good-Robot                  | ☑️        |                     | ☑️                        | Latest code                                  | Game/code is essentially done, no more updates expected |
...
| uHexen2                     | ☑️        |                     | ☑️                        | Latest code                                  | This one's GL version has issues on Apple Silicon I need to hammer out, but the software version is solid|
