...
export APP_VERSION="0.9alpha"
export PRODUCT_NAME="TenhauserGate"
export PROJECT_NAME="TenhauserGate"
export PORT_NAME="TenhauserGate"
export ICONSFILENAME="TenhauserGate"
...
export WRAPPER_NAME="TenhauserGate.app"
export CONTENTS_FOLDER_PATH="TenhauserGate.app/Contents"
export EXECUTABLE_FOLDER_PATH="TenhauserGate.app/Contents/MacOS"
export UNLOCALIZED_RESOURCES_FOLDER_PATH="TenhauserGate.app/Contents/Resources"
export FRAMEWORKS_FOLDER_PATH="TenhauserGate.app/Contents/Frameworks"
export BUNDLE_ID="com.macsourceports.TenhauserGate"
...
codesign --force --options runtime --deep --sign "${SIGNING_IDENTITY}" TenhauserGate.app
...
if [ "$1" == "notarize" ]; then
	...
	echo "zipping..."
	echo ditto -c -k --sequesterRsrc --keepParent "TenhauserGate.app" "${PRE_NOTARIZED_ZIP}"
	ditto -c -k --sequesterRsrc --keepParent "TenhauserGate.app" "${PRE_NOTARIZED_ZIP}"
	...
	echo "stapling..."
	xcrun stapler staple TenhauserGate.app

	echo "notarized"
	echo "zipping notarized..."

	ditto -c -k --sequesterRsrc --keepParent TenhauserGate.app "${POST_NOTARIZED_ZIP}"

	echo "done. ${POST_NOTARIZED_ZIP} contains notarized TenhauserGate.app build."
fi
