...
export APP_VERSION="0.0.13"
export PRODUCT_NAME="defendguin"
export PROJECT_NAME="defendguin"
export PORT_NAME="defendguin"
export ICONSFILENAME="defendguin"
export EXECUTABLE_NAME="defendguin"
export PKGINFO="APPLNBS2"
