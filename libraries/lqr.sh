export SOURCE_URL="https://github.com/carlobaldassi/liblqr/archive/refs/tags/v0.4.2.tar.gz"
export SOURCE_FILE="liblqr-0.4.2.tar.gz"
export MAKE_ARGS="--enable-install-man"
