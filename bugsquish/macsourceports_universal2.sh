...
export PRODUCT_NAME="bugsquish"
export PROJECT_NAME="bugsquish"
export PORT_NAME="bugsquish"
export ICONSFILENAME="bugsquish"
export EXECUTABLE_NAME="bugsquish"
export PKGINFO="APPLNBS1"
