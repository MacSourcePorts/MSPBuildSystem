...
export APP_VERSION="2007.07.04"
export PRODUCT_NAME="entombed"
export PROJECT_NAME="entombed"
export PORT_NAME="entombed"
export ICONSFILENAME="entombed"
export EXECUTABLE_NAME="entombed"
export PKGINFO="APPLNBS3"
