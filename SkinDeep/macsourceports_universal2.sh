...
export PRODUCT_NAME="SkinDeep"
export PROJECT_NAME="SkinDeep"
export PORT_NAME="SkinDeep"
export ICONSFILENAME="doom3"
export EXECUTABLE_NAME="SkinDeep"
export PKGINFO="APPLDHM3"
export GIT_TAG="1.5.4"
export GIT_DEFAULT_BRANCH="upd"
...
/usr/local/bin/cmake -G "Unix Makefiles" -DCMAKE_OSX_ARCHITECTURES=x86_64 -DCMAKE_BUILD_TYPE=Debug -DCMAKE_OSX_DEPLOYMENT_TARGET=13.3 -DSDL2=ON -DOPENAL_LIBRARY=/usr/local/opt/openal-soft/lib/libopenal.dylib -DOPENAL_INCLUDE_DIR=/usr/local/opt/openal-soft/include ../neo -Wno-dev

# cd ..
# rm -rf ${ARM64_BUILD_FOLDER}
# mkdir ${ARM64_BUILD_FOLDER}
# cd ${ARM64_BUILD_FOLDER}
# cmake -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=Release -DCMAKE_OSX_ARCHITECTURES=arm64 -DCMAKE_OSX_DEPLOYMENT_TARGET=13.3 -DSDL2=ON -DOPENAL_LIBRARY=/opt/homebrew/opt/openal-soft/lib/libopenal.dylib -DOPENAL_INCLUDE_DIR=/opt/homebrew/opt/openal-soft/include ../neo -Wno-dev
