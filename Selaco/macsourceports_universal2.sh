...
export GIT_TAG="v0.86G"
export GIT_DEFAULT_BRANCH="macos/0.86G"
...
gsed -i 's|Development Version|0.86G|' "${BUILT_PRODUCTS_DIR}/${CONTENTS_FOLDER_PATH}/Info.plist"
